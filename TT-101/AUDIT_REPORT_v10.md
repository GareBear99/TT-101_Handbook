...
## DIY Games Order (Training Ladder)
- TT-364: Binary Character Atlas (0–255) + Decoder
- TT-366: Binary Crossword (Decode → Solve)
- TT-365: Continuum Hangman (Binary Hints)

Invariant: these three pages must be navigable in-order via sidebar paging and handbook index.
